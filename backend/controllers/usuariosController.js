...
async function createUsuario(req, res) {
    ...
    const query = 'INSERT INTO USUARIO (nombre, contrasenia, apellido, correo, telefono, rol) VALUES (:nombre,:contrasenia,:apellido, :correo, :telefono, :rol)';
    const values = { nombre: nombre, contrasenia: passwordHash, apellido: apellido, correo: correo, telefono: telefono, rol: rol };
    try {
        const connection = await oracledb.getConnection(dbConfig);
